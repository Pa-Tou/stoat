...
/// The size_t in finished_search_states is an identifier for the path. This is based on path_count, which is updated to add the number of distinct
/// paths through the netgraph.
