...
namespace stoat_command
{
    ...
    int main_stoat_graph(int argc, char *argv[])
    {
        ...
        snarl_collection.fill_in_snarl_info(*path_position_graph, distance_index, all_sample_haplotypes,
                                            ...
                                            [&](const net_handle_t &snarl, const snarl_info_t &snarl_data, const std::vector<stoat::sample_hap_t> &sample_haplotypes)
                                            ...
                                            reference_path_names, distance_index.has_distances(),
