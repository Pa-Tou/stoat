...
namespace stoat_command
{
    ...
    int main_stoat_test(int argc, char *argv[])
    {
        ...
        while ((c = getopt_long(argc, argv, "g:m:p:P:w:c:C:I:M:V:o:uh", long_options, nullptr)) != -1)
        {
            ...
            {
            case 'g':
                genotype_path = optarg;
                stoat_vcf::check_file(genotype_path);
                break;
            case 'a':
                ascii = true;
                break;
            case 'm':
                ...
                break;
            case 'p':
                phenotype_path = optarg;
                stoat_vcf::check_file(phenotype_path);
                break;
            case 'c':
                covariate_path = optarg;
                stoat_vcf::check_file(covariate_path);
                break;
            case 'C':
            {
            ...
            case 'I':
                ...
                break;
            case 'P':
                gene_position_path = optarg;
                stoat_vcf::check_file(gene_position_path);
                break;
            case 'w':
