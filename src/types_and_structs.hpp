...
struct snarl_info_t {
    public:
        ...
        snarl_info_t(stoat::node_traversal_t start_node, stoat::node_traversal_t end_node,
                     std::string ref_path, size_t start_position, size_t end_position, size_t depth,
                     ...
                     start_node(start_node), end_node(end_node), ref_path(ref_path),
        ...
        // reference index use to retrieve the chromosome name
        std::string ref_path;
