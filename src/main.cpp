...
// BINARY NODE
// ./stoat vcf --mode node -g ../tests/test_data/input_data/binary/pg.full.pg -d ../tests/test_data/input_data/binary/pg.full.dist -R ../tests/test_data/input_data/binary/pg.chromosome --no-bgzip --output ../output_binary_node

// BINARY NODE GENOTYPE
// ./stoat vcf --mode node -s ../output_binary_node/node_info.tsv -v ../tests/test_data/input_data/binary/merged_output.vcf.gz --no-bgzip --output ../output_binary_node_genotype
...
// BINARY
// ./stoat graph -g ../tests/test_data/input_data/binary/pg.full.pg -d ../tests/test_data/input_data/binary/pg.full.dist -r ref --no-bgzip --output ../output_binary_graph
...
// GDB
// gdb --args ./stoat test -g ../output_binary_graph/snarl_genotypes.tsv -p ../tests/test_data/input_data/binary/phenotype_samples.tsv -m chi2 --no-bgzip --output ../output_binary_graph
// (gdb) run
