...
run_linear_simulation <- function(n_sims, n, k, beta_1, sigma,
  ...
  if (collinearity) {
    ...
    number_last_element <- sample(1:ceiling(n * 0.1), 1)
...
## Near perfect collinearity without merging significant
...
## Near perfect collinearity without merging no significant
...
## Near perfect collinearity with merging significant
...
## Near perfect collinearity with merging no significant
