...
This change can be explained because the stoat vcf used VCF file computed with vg variant calling that can create bad results and stoat graph use the 'ref' haplotype as the correct haplotype, whereas in the simulation it is not.
