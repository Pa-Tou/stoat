...
TEST_CASE( "Untangle simple nested snarl", "[vcf_parser]" ) {
    ...
    */
    ...
    SECTION("Check the untangler") {
        ...
        REQUIRE(parser.does_sample_have_snarl(0, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(1, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(2, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(3, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(4, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(5, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(6, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(7, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(8, ">1>6"));
        REQUIRE(parser.does_sample_have_snarl(9, ">1>6"));

        REQUIRE(!parser.does_sample_have_snarl(0, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(1, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(2, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(3, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(4, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(5, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(6, ">2>5"));
        REQUIRE(!parser.does_sample_have_snarl(7, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(8, ">2>5"));
        REQUIRE(parser.does_sample_have_snarl(9, ">2>5"));

        REQUIRE(!parser.does_sample_have_snarl(0, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(1, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(2, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(3, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(4, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(5, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(6, "<5<2"));
        REQUIRE(!parser.does_sample_have_snarl(7, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(8, "<5<2"));
        REQUIRE(parser.does_sample_have_snarl(9, "<5<2"));
...
TEST_CASE( "Untangle simple nested snarl multiple snps", "[vcf_parser]" ) {
    ...
    */
    ...
    SECTION("Make a VCFParser") {
        ...
        REQUIRE(!parser.does_sample_have_snarl(0, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(1, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(2, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(3, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(4, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(5, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(6, ">5>8"));
        REQUIRE(!parser.does_sample_have_snarl(7, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(8, ">5>8"));
        REQUIRE(parser.does_sample_have_snarl(9, ">5>8"));

        REQUIRE(!parser.does_sample_have_snarl(0, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(1, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(2, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(3, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(4, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(5, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(6, "<8<5"));
        REQUIRE(!parser.does_sample_have_snarl(7, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(8, "<8<5"));
        REQUIRE(parser.does_sample_have_snarl(9, "<8<5"));
...
TEST_CASE( "Untangle three nested snarl multiple snps", "[vcf_parser]" ) {
    ...
    */
    ...
    SECTION("Make a VCFParser") {
        ...
        REQUIRE(!parser.does_sample_have_snarl(0, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(1, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(2, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(3, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(4, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(5, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(6, ">2>7"));
        REQUIRE(!parser.does_sample_have_snarl(7, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(8, ">2>7"));
        REQUIRE(parser.does_sample_have_snarl(9, ">2>7"));


        REQUIRE(!parser.does_sample_have_snarl(0, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(1, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(2, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(3, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(4, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(5, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(6, "<7<2"));
        REQUIRE(!parser.does_sample_have_snarl(7, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(8, "<7<2"));
        REQUIRE(parser.does_sample_have_snarl(9, "<7<2"));

        REQUIRE(parser.does_sample_have_snarl(0, ">3>6"));
        REQUIRE(parser.does_sample_have_snarl(1, ">3>6"));
        REQUIRE(parser.does_sample_have_snarl(2, ">3>6"));
        REQUIRE(!parser.does_sample_have_snarl(3, ">3>6"));
        REQUIRE(!parser.does_sample_have_snarl(4, ">3>6"));
        REQUIRE(!parser.does_sample_have_snarl(5, ">3>6"));
        REQUIRE(parser.does_sample_have_snarl(6, ">3>6"));
        REQUIRE(parser.does_sample_have_snarl(7, ">3>6"));
        REQUIRE(!parser.does_sample_have_snarl(8, ">3>6"));
        REQUIRE(parser.does_sample_have_snarl(9, ">3>6"));

        REQUIRE(parser.does_sample_have_snarl(0, "<6<3"));
        REQUIRE(parser.does_sample_have_snarl(1, "<6<3"));
        REQUIRE(parser.does_sample_have_snarl(2, "<6<3"));
        REQUIRE(!parser.does_sample_have_snarl(3, "<6<3"));
        REQUIRE(!parser.does_sample_have_snarl(4, "<6<3"));
        REQUIRE(!parser.does_sample_have_snarl(5, "<6<3"));
        REQUIRE(parser.does_sample_have_snarl(6, "<6<3"));
        REQUIRE(parser.does_sample_have_snarl(7, "<6<3"));
        REQUIRE(!parser.does_sample_have_snarl(8, "<6<3"));
        REQUIRE(parser.does_sample_have_snarl(9, "<6<3"));
