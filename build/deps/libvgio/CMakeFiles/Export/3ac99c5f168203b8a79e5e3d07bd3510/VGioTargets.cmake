...
foreach(_cmake_expected_target IN ITEMS VGio::VGio VGio::VGio_static)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/VGioTargets-*.cmake")
...
foreach(_target "libhandlegraph::handlegraph_shared" "libhandlegraph::handlegraph_static" )
